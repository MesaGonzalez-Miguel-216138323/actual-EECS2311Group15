 ...
 *       &lt;attribute name="text-x" use="required" type="{http://www.w3.org/2001/XMLSchema}decimal" /&gt;
 *       &lt;attribute name="text-y" use="required" type="{http://www.w3.org/2001/XMLSchema}decimal" /&gt;
...
public class Ending {
    ...
    @XmlAttribute(name = "text-x", required = true)
    protected BigDecimal textX;
    @XmlAttribute(name = "text-y", required = true)
