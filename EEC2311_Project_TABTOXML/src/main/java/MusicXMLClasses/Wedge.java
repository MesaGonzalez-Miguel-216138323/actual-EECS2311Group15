 ...
 *       &lt;attribute name="niente" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" /&gt;
...
public class Wedge {
    ...
    @XmlAttribute(name = "niente", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    protected java.lang.String niente;
     ...
     *     
     */
    public java.lang.String getNiente() {
        return niente;
    }
     ...
     *     
     */
    public void setNiente(java.lang.String value) {
        this.niente = value;
    }
