 ...
 *       &lt;attribute name="cautionary" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" /&gt;
 ...
 *       &lt;attribute name="editorial" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" /&gt;
...
public class Accidental {
    ...
    @XmlAttribute(name = "cautionary", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    ...
    @XmlAttribute(name = "editorial", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
