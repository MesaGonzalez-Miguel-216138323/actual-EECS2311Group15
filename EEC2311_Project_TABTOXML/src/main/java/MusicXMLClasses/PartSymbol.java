 ...
 *       &lt;attribute name="bottom-staff" use="required" type="{http://www.w3.org/2001/XMLSchema}integer" /&gt;
 ...
 *       &lt;attribute name="top-staff" use="required" type="{http://www.w3.org/2001/XMLSchema}integer" /&gt;
 *     &lt;/extension&gt;
 *   &lt;/simpleContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlRootElement(name = "part-symbol")
public class PartSymbol {
    ...
    @XmlAttribute(name = "bottom-staff", required = true)
    ...
    @XmlAttribute(name = "top-staff", required = true)
