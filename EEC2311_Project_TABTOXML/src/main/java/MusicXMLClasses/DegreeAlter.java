 ...
 *       &lt;attribute name="plus-minus" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" /&gt;
...
@XmlRootElement(name = "degree-alter")
public class DegreeAlter {
    ...
    @XmlAttribute(name = "plus-minus", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    protected java.lang.String plusMinus;
     ...
     *     
     */
    public void setPlusMinus(java.lang.String value) {
